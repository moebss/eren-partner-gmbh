...
export function WhatsAppWidget() {
  const whatsappUrl = "https://wa.me/492271000000?text=Hallo%20Eren%20%26%20Partner%20GmbH%2C%20ich%20habe%20eine%20Anfrage%20zu%20einem%20Bauprojekt.";
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="hidden md:group-hover:block absolute right-16 top-1/2 -translate-y-1/2 bg-neutral-900 border border-neutral-800 text-white text-xs font-semibold px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
